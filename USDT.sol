...
contract CherryRewardsUSDT is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    function withdraw(uint256 amount) public updateReward(msg.sender) {
        ...
        require(lockTime[msg.sender] < block.timestamp, "Lock in USDT");
    ...
    function getReward() public updateReward(msg.sender) {
        require(block.timestamp > startTime + 3 days, "Lockin time");
